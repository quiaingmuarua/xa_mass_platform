...
public class TaskStateValidationResult {
    ...
    public enum ViolationCode {
        ...
        BLOCKED_HOLD_REASON_MISSING,
        HOLD_REASON_PRESENT_ON_NON_BLOCKED,
        OPEN_INTAKE_FINALIZED_NON_MANUALLY,
        ...
        TASK_MSG_FINAL_REASON_MISSING,
        TASK_MSG_FINAL_REASON_STATUS_MISMATCH,
        MULTIPLE_ACTIVE_ATTEMPTS_FOR_MESSAGE,
        ACTIVE_ATTEMPT_WITH_FINAL_MESSAGE,
        ALL_ATTEMPTS_FINAL_BUT_MESSAGE_NOT_FINAL
    }
