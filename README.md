...
- Embedded transport delivery uses runtime-level admission control: in-memory delivery has a total queued-item cap plus per-worker caps, and exposes store stats for backlog diagnostics before Redis/JDBC replacement.
