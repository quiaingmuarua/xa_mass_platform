...
- `platform_infra/mass-storage-memory`: in-memory control-plane task/worker/submitter storage used by the SDK/server default embedded path and focused tests
