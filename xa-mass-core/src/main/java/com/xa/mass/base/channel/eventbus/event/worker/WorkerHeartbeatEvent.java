...
public class WorkerHeartbeatEvent extends MassEvent.BaseMassEvent {
    private final String workerId;
    private final String reason;

    public WorkerHeartbeatEvent(String workerId, String reason, String traceId) {
        super(
                "WORKER_HEARTBEAT",
                MassPlatformEventType.WORKER_HEARTBEAT,
                String.format("Worker %s heartbeat: %s", workerId, reason),
