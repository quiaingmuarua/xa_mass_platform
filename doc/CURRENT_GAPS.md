...
| Engine `DATABASE` factory methods remain fail-fast | `xa-mass-server` owns the focused H2 path behind `mass.storage.mode=h2` | [VERIFIED_RUNBOOK.md](./VERIFIED_RUNBOOK.md) |
