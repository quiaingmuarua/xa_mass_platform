...
| Resume short-circuit where a paused task is already complete underneath | **Closed** by `TaskApiResumeShortCircuitIntegrationTest`: 409 conflict on resume-of-TERMINAL and resume-of-RUNNING; kept in the non-scheduling lifecycle/result gate | [xa-mass-server/README.md](../xa-mass-server/README.md), [E2E_BASELINE.md](./E2E_BASELINE.md) |
