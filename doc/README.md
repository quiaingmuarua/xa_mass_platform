...
- [INTEGRATIONS_WORKER_PACK_SDK_CONVERGENCE_ROADMAP.md](./INTEGRATIONS_WORKER_PACK_SDK_CONVERGENCE_ROADMAP.md) - completed convergence record; successor is `INTEGRATIONS_EXTERNAL_SDK_WORKER_PACK_HARDENING_ROADMAP.md`
