...
| engine -> transport dispatch payload | runtime state | claim/lease-owned hot-path delivery truth | bounded in-memory or Redis `RouteTargetedTaskDispatchHandoff` after claim only | JDBC/review-row truth or a duplicate ready queue |
