...
| Layer | Owner | Meaning |
| --- | --- | --- |
| worker action reply | `WorkerActionReply` / adapter worker frame | worker-submitted result body at SDK/server or adapter boundary; does not own retry, finality, or terminal policy |
