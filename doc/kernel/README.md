...
- [Worker Score](../../kernel_jvm/doc/score/worker-score-band-scheduling.md): private polarity/time/dirty encoding, scheduling observation and controls, Java composition and fixed atomic operations
