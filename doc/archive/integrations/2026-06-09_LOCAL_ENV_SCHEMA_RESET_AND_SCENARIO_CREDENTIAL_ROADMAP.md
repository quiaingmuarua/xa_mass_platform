...
>
> Historical implementation record only. Current local schema reset rules live
> in `xa-mass-server/README.md`; current scenario environment initialization
> uses `tools/xa-mass-admin-cli env init` and the platform confidence smoke.
