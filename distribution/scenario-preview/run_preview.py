...
def build():
    ...
    subprocess.run([str(gradle), ":distribution:scenario-preview:stageServer", ":distribution:scenario-preview:stageFrontend",
                    ":distribution:scenario-preview:stageHost",
...
class Preview:
    ...
    def start(self):
        ...
        if packaged:
            ...
            configuration = self.root / "build" / "config"
