...
Android Worker through HTTP bound only to `127.0.0.1:18084`.
...
small listener lifecycle. The module depends only on Worker Core and
NanoHTTPD; it owns no Worker identity, network Client, Task, or scheduling
state.
