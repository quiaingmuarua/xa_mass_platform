...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleUnauthenticated(ApiUnauthenticatedException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponse<?>> handleForbidden(ApiForbiddenException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponse<?>> handleConflict(IllegalStateException ex, HttpServletRequest request) {
        ServerApiFailureAttributes.markFailure(request, ServerApiFailureAttributes.CONFLICT, ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<?>> handleBadJson(HttpMessageNotReadableException ex, HttpServletRequest request) {
        ...
        ServerApiFailureAttributes.markFailure(request, ServerApiFailureAttributes.BAD_REQUEST, "Request body is invalid");
    ...
    public ResponseEntity<ApiResponse<?>> handleMethodNotAllowed(HttpRequestMethodNotSupportedException ex,
        ...
        ServerApiFailureAttributes.markFailure(request, ServerApiFailureAttributes.METHOD_NOT_ALLOWED,
    ...
    public ResponseEntity<ApiResponse<?>> handleException(Exception ex, HttpServletRequest request) {
        ...
        ServerApiFailureAttributes.markFailure(request, ServerApiFailureAttributes.UNHANDLED, "Internal Server Error");
