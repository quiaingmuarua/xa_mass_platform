...
public class TestDevBootstrapConfiguration {
    ...
    private void registerMockTaskDefinitions(MassSdkApplication app) {
        ...
        registerCatalogTaskDefinition(app, EventDefinition.builder()
                ...
                .description("Update future sample task response delay on a targeted worker through the task path.")
                .payloadTypes(List.of(PayloadType.JSON))
                .taskModes(List.of(TaskMode.SINGLE_RUN))
                .projectCodes(List.of("demoApp", "testApp"))
                .build());
        ...
        registerCatalogTaskDefinition(app, EventDefinition.builder()
                ...
                .description("Override future sample task result status on a targeted worker through the task path.")
                .payloadTypes(List.of(PayloadType.JSON))
                .taskModes(List.of(TaskMode.SINGLE_RUN))
                .projectCodes(List.of("demoApp", "testApp"))
                .build());
        registerCatalogTaskDefinition(app, EventDefinition.builder()
                ...
                .description("Disconnect a targeted sample worker after its task result is returned.")
                .payloadTypes(List.of(PayloadType.JSON))
                .taskModes(List.of(TaskMode.SINGLE_RUN))
                .projectCodes(List.of("demoApp", "testApp"))
                .build());
