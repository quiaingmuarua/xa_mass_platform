...
This package keeps the single internal runtime context used by WebSocket adapter dispatch code:

- `WebSocketDispatchRuntimeContext`

Current role:

- it is a local adapter/runtime seam for WebSocket adapter internals
