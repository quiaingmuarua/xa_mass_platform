...
```bash
./mvnw -f integrations/samples/java/worker-websocket/pom.xml -DskipTests package
```

Run:

```bash
java -jar integrations/samples/java/worker-websocket/target/worker-websocket-java-sample.jar
```
