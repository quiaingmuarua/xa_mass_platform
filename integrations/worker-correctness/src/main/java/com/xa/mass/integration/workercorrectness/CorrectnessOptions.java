...
final class CorrectnessOptions {
    ...
    private CorrectnessOptions(Map<String, String> values) {
        this.values = Map.copyOf(values);
    }

    static CorrectnessOptions parse(String[] arguments) {
        ...
        return new CorrectnessOptions(values);
    }
    ...
    Path correctnessSpec() {
        return absolutePath(values.getOrDefault(
                "correctness-spec",
                "correctness-spec.json"
        ));
    }
