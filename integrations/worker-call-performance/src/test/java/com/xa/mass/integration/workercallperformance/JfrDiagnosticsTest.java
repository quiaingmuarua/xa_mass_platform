...
class JfrDiagnosticsTest {
    ...
    @Test void exportWhitelistsFieldsAndLeavesMissingCoverageAndInapplicablePoolExplicit() throws Exception {
        ...
        try (var recording = new Recording()) {
            ...
            stage.batchSize = 3;
            stage.commit();
            for (String name : java.util.List.of("REFILL_ROUND","INITIAL_HOLD","REFILL_OBSERVATION","WORKER_CONFIRM_REJECTED")) {
        ...
        assertThat(json).contains("REFILL_ROUND", "INITIAL_HOLD", "REFILL_OBSERVATION", "WORKER_CONFIRM_REJECTED", "UNRECOGNIZED", "\"batchSize\":3", "\"active\":null", "\"queued\":null")
