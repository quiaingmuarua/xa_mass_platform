...
`10 x B` Items/s (`B` = the fixed assignment ceiling of 100). Cases offered within that budget
...
about 224,000 accepted Items); the scheduled 100-Worker Task suite keeps 180 seconds. Evidence records `drainBudgetSeconds` and the
