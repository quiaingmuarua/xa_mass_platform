...
public class AndroidWorkerEndpointCacheStoreTest {
    ...
    public void corruptCacheIsDiscardedWithoutTouchingIdentity() {
        assertTrue(application.getSharedPreferences(
                ...
                .putString("workerGroupId", "android-demo-workers")
                .putString("clientWorkerKey", "installation-1")
                .putString("workerId", WORKER_ID)
                .putString("cachedWorkerGroupId", "android-demo-workers")
                .putString("cachedEndpointUri", "not-a-uri")
                .commit());
