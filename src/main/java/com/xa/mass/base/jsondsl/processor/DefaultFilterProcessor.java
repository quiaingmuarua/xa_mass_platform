...
import com.xa.mass.base.jsondsl.model.FilterReport;
import com.xa.mass.base.jsondsl.model.FilterResult;
        ...
        for (T obj : data) {
            ...
            if (fieldConds != null) {
                for (Map.Entry<String, Object> entry : fieldConds.entrySet()) {
                    ...
                    try {
                        Object result = TemplateValueResolver.resolve(cond, dslContext, (k, c) -> val);
                        // 只要有一个字段条件不通过就 fail
            ...
            if (combineConds != null) {
                for (Map.Entry<String, Object> entry : combineConds.entrySet()) {
                    ...
                    try {
                        Object result = TemplateValueResolver.resolve(expr, dslContext, (k, c) -> objMap.get(k));
                        boolean ok = false;
