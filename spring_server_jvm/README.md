...
The preview profile is also copied into [Scenario Preview](../distribution/scenario-preview/README.md)
...
```text
./gradlew :spring_server_jvm:bootRun
```
...
```powershell
.\gradlew.bat :spring_server_jvm:bootJar
.\gradlew.bat :spring_server_jvm:test
.\gradlew.bat :spring_server_jvm:smsCompositionIntegrationTest :spring_server_jvm:scenarioCompositionIntegrationTest
```
