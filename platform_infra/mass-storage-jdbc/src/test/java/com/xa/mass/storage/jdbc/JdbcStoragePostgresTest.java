...
class JdbcStoragePostgresTest {
    ...
    private StorageFixture postgresFixture(String testId) {
        ...
        config.setJdbcUrl(EmbeddedPostgresSupport.isolatedJdbcUrl(testId));
        config.setUsername(EmbeddedPostgresSupport.username());
        config.setPassword(EmbeddedPostgresSupport.password());
