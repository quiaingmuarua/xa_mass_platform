...
The current stable event registry is the `ExecutionEventType` enum. Do not
hand-maintain a second event list here; update the enum, tests, and
[`TRACE_CONTRACT.md`](../../doc/TRACE_CONTRACT.md) together when the registry
changes.
