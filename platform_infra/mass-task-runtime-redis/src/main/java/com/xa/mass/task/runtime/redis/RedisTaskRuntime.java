...
public final class RedisTaskRuntime implements TaskRuntimeWorkPort,
    ...
    private final RedisScoreBandTaskRuntime delegate;
    ...
    public RedisTaskRuntime(RedisClient client, String namespace, LongSupplier clock) {
        ...
        String resolvedNamespace = requireText(namespace, "namespace");
        this.connection = client.connect();
        this.delegate = new RedisScoreBandTaskRuntime(
                connection.sync(),
                resolvedNamespace,
