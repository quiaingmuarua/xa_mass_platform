...
public final class RuleInputs {
    private RuleInputs() { }
    public static Map<String, Object> object(Object input, Set<String> fields) {
    ...
    public static List<String> strings(Object input) {
    ...
    public static List<String> countries(Object input) {
