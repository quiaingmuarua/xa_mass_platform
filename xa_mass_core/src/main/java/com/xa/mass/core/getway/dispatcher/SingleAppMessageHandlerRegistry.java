...
public class SingleAppMessageHandlerRegistry {
    ...
    public static void registerWithApp(MessageType type, String subMsgType, MessageHandler handler) {
        String key = type.name() + "::" + subMsgType;
        handlerMap.put(key, handler);
    }

    public static Optional<MessageHandler> resolveWithApp(MassMessage msg) {
