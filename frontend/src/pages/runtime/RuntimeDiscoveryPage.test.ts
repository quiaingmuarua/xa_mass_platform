                    ...
                    data: [
                        {
                            ...
                            declaredWorkerIds: ['dns-url-inspector-poll-001', 'dns-url-inspector-ws-001'],
                            reachableWorkerIds: ['dns-url-inspector-poll-001', 'dns-url-inspector-ws-001'],
                        ...
                        },
                        {
                            ...
                            reachableWorkerIds: [],
                            hasDirectRuntimeHandler: false,
                            hasReachableWorkerCoverage: false,
                            hasInvocationCoverage: false,
                        },
                        {
...
describe('RuntimeDiscoveryPage', () => {
    ...
    it('combines the catalog and live workers into a discovery view', async () => {
        ...
        expect(wrapper.text()).toContain(
            'Project directory, event capability inventory, and worker reachability in one control-plane view',
        )
