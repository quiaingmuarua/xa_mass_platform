    ...
    <header class="page-header">
      <div>
        ...
        <p class="page-subtitle">
          ...
          backend worker truth and keeps edit scope limited to supported
          projects.
        </p>
      </div>
      ...
      <el-table v-else :data="workers" row-key="workerId">
        ...
        <el-table-column label="Projects" min-width="220">
          <template #default="{ row }">
            ...
            <span v-if="row.supportedProjects.length === 0" class="row-secondary">
              none
            </span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="lastHeartbeat" label="Last heartbeat" min-width="180" />
