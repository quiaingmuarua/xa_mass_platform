    ...
    deviceProbe: {
        ...
        items: [
            ...
            },
            {
                ...
                defaultRegion: 'GB',
                countryIso2: 'GB',
                requiredNetworkOperatorMccMnc: '23415',
                sleepMs: 90,
                timeoutMs: 3000,
                expectedOutcome: 'VALID_E164',
                traceLabel: 'phone-gb-valid',
            ...
            },
            {
                ...
                defaultRegion: 'US',
                countryIso2: 'US',
                requiredNetworkOperatorMccMnc: '310260',
                sleepMs: 90,
                timeoutMs: 3000,
                expectedOutcome: 'VALID_E164',
                traceLabel: 'phone-us-valid',
                requiredFingerprintProfile: 'fp-android-sg-c',
            },
            {
                phoneNumber: 'not-a-phone',
                defaultRegion: 'SG',
                countryIso2: 'ZZ',
                requiredNetworkOperatorMccMnc: '00000',
                sleepMs: 90,
                timeoutMs: 3000,
