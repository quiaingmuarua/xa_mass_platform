...
const mockTaskDetails: Record<string, TaskDetailResponse> = {
    'task-001': {
        task: {
            ...
            sharedConfig: {
                ...
                objective: 'verify public probe endpoints before approval',
            },
            user: {
                name: 'public-probe-runner',
            },
            taskTargetNumber: 240,
            taskEligibleNumber: 240,
            taskSuccessNumber: 0,
            taskNonSuccessNumber: 240,
    ...
    'task-002': {
        task: {
            ...
            sharedConfig: {
                scenario: 'control-console-realistic',
                objective: 'verify phone metadata routing',
                workerGroupId: 'phone-device-probe',
                requiredFingerprintProfile: 'fp-android-sg-a',
            },
            user: {
                name: 'device-probe-runner',
            },
            taskTargetNumber: 180,
            taskEligibleNumber: 180,
            taskSuccessNumber: 2,
            taskNonSuccessNumber: 178,
            peakAssignedWorkerCount: 0,
    ...
    'task-003': {
        task: {
            ...
            sharedConfig: {
                scenario: 'control-console-realistic',
                objective: 'verify local data quality fixtures',
            },
            user: {
                name: 'data-quality-runner',
            },
            taskTargetNumber: 620,
            taskEligibleNumber: 620,
            taskSuccessNumber: 0,
            taskNonSuccessNumber: 620,
            peakAssignedWorkerCount: 0,
...
const mockTaskReviews: Record<string, TaskReviewResponse> = {
    'task-001': {
        ...
        seedPreview: [
            {
                messageId: 'msg-001',
                eventCode: 'probe.weather.current',
                status: 'READY',
                payloadRef: null,
                retryCount: 0,
                maxRetryCount: 3,
            ...
            },
            {
                ...
                input: {
                    ...
                    traceLabel: 'http-unexpected-status',
                },
            },
        ],
        resultPreview: [
