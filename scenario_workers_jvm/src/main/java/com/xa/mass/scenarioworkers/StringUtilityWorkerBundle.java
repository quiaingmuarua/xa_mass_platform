...
final class StringUtilityWorkerBundle
        implements ScenarioWorkerBundleLifecycle {

    private static final System.Logger LOGGER = System.getLogger(
            StringUtilityWorkerBundle.class.getName()
    );
    ...
    StringUtilityWorkerBundle(
        ...
        this(
                ...
                workerRuntime,
                propertyIndex,
                StringUtilityWorkerBundle::createWorker
        );
    }
    ...
    public void start() {
        synchronized (this) {
            if (closed) {
                throw new IllegalStateException(
                        "String-utility Worker bundle is closed"
                );
            }
            if (started) {
                return;
        ...
        try {
            ...
            throw new ScenarioWorkerAssemblyException(
                    WORKER_START_FAILED,
                    "stringUtilityWorkerBundle.start",
    ...
    private void upsertWorkerGroup() {
        WorkerRuntimeResult result = workerCatalog.upsertWorkerGroup(
                new WorkerGroupDescriptor(
                        ...
                        Map.of("capability", "string-utils"),
    ...
    private void awaitConnections() {
        ...
        while (System.nanoTime() < deadline) {
            ...
            try {
                ...
                throw new ScenarioWorkerAssemblyException(
                        WORKER_START_FAILED,
                        "stringUtilityWorkerBundle.awaitConnections",
