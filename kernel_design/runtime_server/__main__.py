...
def main() -> None:
    parser = argparse.ArgumentParser(description="Start the Python Kernel Command Server.")
    ...
    try:
        ...
        raise RuntimeError("uvicorn is required for the Python Kernel Command Server") from error
    uvicorn.run(
