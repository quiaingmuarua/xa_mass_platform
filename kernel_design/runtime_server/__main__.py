...
def main() -> None:
    parser = argparse.ArgumentParser(description="Start the Kernel Runtime Server.")
    ...
    try:
        ...
        raise RuntimeError("uvicorn is required for the Kernel Runtime Server") from error
    uvicorn.run(
