...
ZSET owner, plus DeliverSeed, the DeliverSeedQueue owner surface, and
TaskItemDispatchPacer. Result routing, a DeliverSeedQueue storage
implementation, and DeliverSeed outbound delivery remain gaps.
