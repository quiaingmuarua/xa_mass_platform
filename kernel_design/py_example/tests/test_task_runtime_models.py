...
class TaskRuntimeModelTest(unittest.TestCase):
    ...
    def test_task_runtime_contracts_are_package_exports(self) -> None:
        ...
        self.assertIs(py_example.TaskItem, TaskItem)
        self.assertIs(py_example.TaskItemAppendResult, TaskItemAppendResult)
        self.assertIs(py_example.TaskItemAppendStatus, TaskItemAppendStatus)
