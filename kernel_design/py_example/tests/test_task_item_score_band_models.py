...
class TaskItemScoreBandModelTest(unittest.TestCase):
    ...
    def test_removed_operation_specific_contracts_do_not_survive(self) -> None:
        ...
        self.assertFalse(hasattr(py_example, "TaskItemClaimResult"))
        self.assertFalse(hasattr(py_example, "TaskItemClaimStatus"))
        self.assertFalse(hasattr(py_example, "TaskItemFinalOutcome"))

    def test_contracts_are_package_exports(self) -> None:
        self.assertIs(py_example.TaskItemScoreBand, TaskItemScoreBand)
        self.assertIs(py_example.TaskItemScoreBandCore, TaskItemScoreBandCore)
        self.assertIs(py_example.TaskItemScoreState, TaskItemScoreState)
        self.assertIs(
            py_example.TaskItemScoreTransitionResult,
            TaskItemScoreTransitionResult,
        )
        self.assertIs(
            py_example.TaskItemScoreTransitionStatus,
            TaskItemScoreTransitionStatus,
        )
