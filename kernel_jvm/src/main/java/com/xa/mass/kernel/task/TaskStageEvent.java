...
@Name("xa.mass.TaskSubmission") @Label("Task call stage") @Category("XA Mass")
@Enabled(false) @StackTrace(false)
final class TaskStageEvent extends Event {
    private static final EventType TYPE = EventType.getEventType(TaskStageEvent.class);
    public String stage;
    public String key;
