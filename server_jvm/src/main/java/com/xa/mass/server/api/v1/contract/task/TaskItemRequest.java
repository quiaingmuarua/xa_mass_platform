...
public record TaskItemRequest(
        ...
        @Schema(description = "{} selects within the bound Rule. Only worker.default accepts {workerId: [id, ...]}, scoped to its WorkerGroup. "
                + "Other query parameters belong to the Handler. Existing country queries use {worker.country: [CN, ...]}; "
                + "country accepts 1..100 strict [A-Z]{2} values. Named Rules reject workerId. "
