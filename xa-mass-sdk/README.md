...
- audit and compatibility diagnostics after `start()`: `getTaskMessages(...)`, `resolveTaskState(...)`, `validateTaskState(...)` (bounded runtime validation, not a deep message-projection audit)
