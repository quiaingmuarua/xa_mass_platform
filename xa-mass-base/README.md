...
canTransitionTo(TaskStatus.BLOCKED)){
        task.
...
canTransitionTo(TaskStatus.READY)){
        task.
...
canTransitionTo(TaskStatus.RUNNING)){
        task.
...
canTransitionTo(TaskStatus.PAUSED)){
        task.
...
canTransitionTo(TaskStatus.TERMINAL)){
        task.

setStatus(TaskStatus.TERMINAL);
}
```
